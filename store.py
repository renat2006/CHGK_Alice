...
right_answer_messages = ["Правильно! ", "Правильный ответ! ", "Молодец! Ответ правильный. ",
                         ...
                         "Отлично! Ты ответил верно! ",
                         "Правильный ответ! Продолжай в том же духе! ",
                         "Умница! Ты знаешь свои факты! ",
                         "Молодец! Твой ответ верный! ",
                         "Браво! Ты настоящий знаток! ",
                         "Ответ правильный! Ты действительно разбираешься! ",
                         "Ты справился! Ты на верном пути! ",
                         "Именно так! Ты заслужил похвалу! ",
                         "Ответ верный! Ты справился с викториной! ",
                         "Поздравляю! Ты ответил правильно! ",
                         "Ответ просто совершенен! Ты гений! ",
                         "Умение точно отвечать – твоя суперсила! ",
                         "Ты отлично справляешься с вопросами! ",
                         "Ты настоящий эксперт! Так держать! ",
                         "Твой уровень знаний поражает! Браво! ",
                         "Твоя эрудиция впечатляет! Продолжай в том же духе! ",
                         "Ты точно знаешь ответы! Молодец! ",
                         "Ты лучший викторинщик! Твой ответ верный! ",
                         "Твоя уверенность в ответе восхитительна! Так держать! ",
                         "Ты знаешь все правильные ответы! Просто впечатляюще! ",
                         "Отлично! Ты ответил верно! ",
                         "Правильный ответ! Продолжай в том же духе! ",
...
wrong_answer_messages = ["Подумай ещё! ", "Неверный ответ! ", "Близко, но нет! ", "Не могу принять этот ответ. ",
                         "Нет, попробуй ещё! ", "Не совсем точно. Попробуйте еще раз.",
                         "Ой, нет. Это неправильный ответ. ",
                         "Увы, но ваш ответ неверен. ",
                         "Неправильно. Попробуйте еще раз! ",
                         "Не совсем так. Вам нужно подумать еще. ",
                         "Упс! Ваш ответ не верен. ",
                         "Увы, но это неверно. Попробуйте еще раз. ",
                         "Неудача! Правильный ответ был другой. ",
                         "Ошибочка! Неправильный ответ. ",
                         "К сожалению, это неверный ответ. ",
                         "Нет, не совсем так. Попробуйте еще раз. ",
                         "Ой, нет. Правильный ответ - совсем другой. ",
                         "Увы, ваш ответ неверен. Попробуйте еще раз. ",
                         "Нет, не верно. Попробуйте снова! ",
                         "Ой, ошибка! Ваш ответ неверен. ",
                         "К сожалению, неправильно. Попробуйте еще раз. ",
                         "Упс! Ваш ответ неправильный. Попробуйте снова! ",
                         "Ошибочка! Неверный ответ. ",
                         "Нет, не так. Попробуйте снова! ",
                         "Увы, но это неверный ответ. Попробуйте еще раз. ",
                         "Увы, неправильный ответ. ",
                         "Нет, это не верно. ",
                         "Не совсем так. ",
                         "Попробуйте еще раз. ",
                         "Ошибочка! Правильный ответ - совсем другой. ",
                         "Упс! Не верно. ",
                         "Неудача! Правильный ответ был другим. ",
                         "Неправильно, но не расстраивайтесь, попробуйте еще раз! ",
                         "Ой, нет. Правильный ответ совсем другой. ",
                         "Увы, но это неправильно. ",
                         ]
super_round_message = [
    "Поздравляю вы добрались до супер-раунда! Сейчас я оглашу его правила. "
    "Ваша задача всё та же, верно отвечать на вопросы, но теперь если вы отвечаете неверно - вы выбываете, "
